" Author:  iamjay (tyberion@gmail.com)
"
...
source /home/iamjay/.vim/mappings/MapIt
source /home/iamjay/.vim/mappings/mybinds
...
" Cursor Movement ************************************************
" Make cursor move by visual lines instead of file lines (when wra
"map <up> gk
"map k gk
"imap <up> <C-o>gk
"map <down> gj
...
"imap <down> <C-o>gj
"map E ge
let g:fuzzy_roots=['/home/iamjay/java/VeriDebug/','/home/iamjay/documents','/home/iamjay/mutt','/home/iamjay/tex','/home/iamjay/training','/home/iamjay/irclogs/']
let g:fuzzy_ignore='*.pyc;*.pyo;.svn;*.suo;*.vcproj;*.o;*.obj;.git;*.bmp;*.jp*g;*.png;*.class;*.pdf;*.aux;*.out;*.toc;*.vpp;*.ep;*.eps;*.ptm;*.gif'
...
if $COLORSCHEME == "light" && (&t_Co > 16 || has('gui_running'))
  ...
  colorscheme wombat  " 256 color light scheme
elseif $COLORSCHEME == "light"
  colorscheme biogoo      " 16 color light scheme
elseif &t_Co > 16 || has('gui_running')
  "colorscheme ir_black " 256 color dark scheme
  "colorscheme godlyleaf " 256 color light scheme
  "colorscheme wombat " 256 color dark scheme
  colorscheme twilight " 256 color dark scheme
else
...
noremap <m-o><m-r> :MRU<cr>
noremap <m-o>r :MRU<cr>/
"makes you able to exec the current line in current buffer by pressing f2 
noremap <F2>   :exec getline('.')<cr>
...
iabbr _me iamjay (tyberion@gmail.com)<C-R>=EatChar('\s')<CR>
iabbr mfg Mit freundlichen Grüßen,<C-R>=EatChar('\s')<CR>
iabbr _js Jörg Schmalfuß<C-R>=EatChar('\s')<CR>
